    ...
    const browsePrefix = async () => {
      ...
      return (
        ...
        {runner !== "Steam" && (
          ...
          <input type="text" value={exe} onChange={(e) => setExe(e.target.value)} placeholder="Select or enter path" />
        ...
        {runner === "Steam" && (
          ...
          <input type="text" value={appId} onChange={(e) => setAppId(e.target.value)} placeholder="e.g. 570" />
          </>
        )}
        ...
        {isWineOrProton && (
          ...
          <div className="input-group">
          <input type="text" value={prefix} onChange={(e) => setPrefix(e.target.value)} placeholder="Leave empty for auto" />
        ...
        <input type="text" value={launchOptions} onChange={(e) => setLaunchOptions(e.target.value)} placeholder="--fullscreen --gamescope --width=1920 ..." />

        <label className="form-label">FPS Limit</label>
        <input type="number" value={fpsLimit} onChange={(e) => setFpsLimit(e.target.value)} placeholder="e.g. 60 (Gamescope only)" />
